...
# Establishes BDT regressor for muon-neutrino energy reconstruction.
# Arguments are a list of nugen simulation files for training.
# Outputs many useful plots for debugging.
